...
class PublicUserApiTests(TestCase):
    ...
    # setUp (note camel case) sets up any testing environment variables required - i.e. the API client from DRF
    def setUp(self):
    ...
    def test_create_token_blank_password(self):
        """Test returns error if no password"""
        payload = {
            "email": "test@example.com",
            "password": "",
        }
    ...
    def test_user_unauthorised(self):
...
class PrivateUserApiTests(TestCase):
    ...
    def test_post_me_not_allowed(self):
        """Test POST not supported on the user/me endpoint"""
